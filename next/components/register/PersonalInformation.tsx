  ...
  return (
    <Article>
      ...
      <ul className="list_indent2 mgt10">
        ...
        <p className="ls2">서비스 제공, 콘텐츠 제공, 본인인증을 목적으로 개인정보를 처리합니다.</p>
        <br />
      </ul>
      <br />
      <br />
      <p className="lh6 bs4">
        ...
        <br />
        <br />① <em className="emphasis">&lt; 바디토리 &gt;</em>은(는) 법령에 따른 개인정보 보유·이용기간 또는
      ...
      <p className="lh6 bs4">
        ...
        <br />
        <br /> ① <em className="emphasis">&lt; 바디토리 &gt;</em>은(는) 다음의 개인정보 항목을 처리하고 있습니다.
      </p>
      <ul className="list_indent2 mgt10">
        <li className="tt">1&lt; 홈페이지 회원가입 및 관리 &gt;</li>
        <li>필수항목 : 이메일, 비밀번호, 로그인ID, 성별, 생년월일, 이름, 서비스 이용 기록, 쿠키</li>
        <li>선택항목 : 휴대전화번호, 접속 로그, 접속 IP 정보</li>
      </ul>
      <br />
      <br />
      <p className="lh6 bs4">
      ...
      <p className="sub_p mgt10">
        <em className="emphasis">
          ② <span className="colorLightBlue">&lt; 바디토리 &gt;</span>은(는) 다음과 같이 개인정보를 제3자에게 제공하고
          있습니다.
        </em>
      </p>
      <ul className="list_indent2 mgt10">
        <li className="tt">
          <em className="emphasis">1. &lt; 회원이 기록을 공유한 병원 &gt;</em>
        </li>
        <li>
          <em className="emphasis">개인정보를 제공받는 자 : 회원이 기록을 공유한 병원</em>
        </li>
        <li>
          <em className="emphasis">제공받는 자의 개인정보 이용목적 : 이메일, 로그인ID, 성별, 생년월일, 이름</em>
        </li>
        <li>
      ...
      <em className="emphasis">
        ...
        <p className="lh6 bs4">
          ...
          <br />
          <br /> ① <em className="emphasis">&lt; 바디토리 &gt;</em>은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이
        ...
        <p className="sub_p mgt10">
          ② <span className="colorLightBlue">&lt; 바디토리 &gt;</span>은(는) 위탁계약 체결시 「개인정보 보호법」
          제26조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한
        ...
        <p className="ls2">
          <em className="emphasis">
            <br />① &lt; 바디토리 &gt; 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을
            ...
            <br />
            1. 파기절차
            <br /> &lt; 바디토리 &gt; 은(는) 파기 사유가 발생한 개인정보를 선정하고, &lt; 바디토리 &gt; 의 개인정보
        ...
        <p className="sub_p">
          <em className="emphasis">전자적 파일 형태의 정보는 기록을 재생할 수 없는 기술적 방법을 사용합니다</em>
        </p>
        <em className="emphasis">
          <br />
          <br />
          ...
          <p className="ls2">
            <br />
            <br />① 정보주체는 바디토리에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수
            있습니다.
          </p>
          <p className="sub_p">
            ② 제1항에 따른 권리 행사는바디토리에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편,
            모사전송(FAX) 등을 통하여 하실 수 있으며 바디토리은(는) 이에 대해 지체 없이 조치하겠습니다.
          </p>
          <p className="sub_p">
          ...
          <p className="sub_p">
            ⑥ 바디토리은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한
          ...
          <p className="sub_p mgt10">
            ...
            <br />
            4. 개인정보의 암호화
            <br /> 이용자의 개인정보는 비밀번호는 암호화 되어 저장 및 관리되고 있어, 본인만이 알 수 있으며 중요한
            데이터는 파일 및 전송 데이터를 암호화 하거나 파일 잠금 기능을 사용하는 등의 별도 보안기능을 사용하고
            있습니다.
            <br />
            <br />
            5. 개인정보에 대한 접근 제한
            <br /> 개인정보를 처리하는 데이터베이스시스템에 대한 접근권한의 부여,변경,말소를 통하여 개인정보에 대한
            접근통제를 위하여 필요한 조치를 하고 있으며 침입차단시스템을 이용하여 외부로부터의 무단 접근을 통제하고
            있습니다.
            <br />
            <br />
            6. 비인가자에 대한 출입 통제
            <br /> 개인정보를 보관하고 있는 물리적 보관 장소를 별도로 두고 이에 대해 출입통제 절차를 수립, 운영하고
            있습니다.
            <br />
            <br />
          </p>
          ...
          <p className="ls2">
            <br />
            <br />① 바디토리 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는
            ‘쿠키(cookie)’를 사용합니다.
          ...
          <p className="lh6 bs4">
            <strong>제10조(행태정보의 수집·이용·제공 및 거부 등에 관한 사항)</strong>
          </p>
          <p className="ls2">
            <br />
            <br />
          ...
          <p className="lh6 bs4">
            <strong>
              제11조(추가적인 이용·제공 판단기준)<em className="emphasis"></em>
            </strong>
            <em className="emphasis">
              <br />
              <br />
              &lt; 바디토리 &gt; 은(는) ｢개인정보 보호법｣ 제15조제3항 및 제17조제4항에 따라 ｢개인정보 보호법 시행령｣
              제14조의2에 따른 사항을 고려하여 정보주체의 동의 없이 개인정보를 추가적으로 이용·제공할 수 있습니다.
              <br /> 이에 따라 &lt; 바디토리 &gt; 가(이) 정보주체의 동의 없이 추가적인 이용·제공을 하기 위해서 다음과
              같은 사항을 고려하였습니다.
          ...
          <p className="sub_p"></p>
          <p className="sub_p">
            <em className="emphasis">▶ 개인정보의 추가적인 이용·제공이 정보주체의 이익을 부당하게 침해하는지 여부</em>
          </p>
          <p className="sub_p"></p>
          <p className="sub_p"></p>
          <p className="sub_p">
            <em className="emphasis">▶ 가명처리 또는 암호화 등 안전성 확보에 필요한 조치를 하였는지 여부</em>
          </p>
          <p className="sub_p"></p>
          <p className="sub_p"></p>
          <p className="sub_p"></p>
